<template>
  <div class="Properller">
    <fish-row>
      <fish-col span="6" class="demo-col">ชุดใบพัดปั้ม</fish-col>
      <fish-col span="6" class="demo-col"
        >ดูจุดแตกร้าว ซึกหรอ การหมุน การสั่นสะเทือน เสียงดัง
        การกัดกรอน</fish-col
      >
      <fish-col span="6" class="demo-col">
      ...
      <fish-col span="6" class="demo-col">
        <fish-input
          ...
          v-model="pumpall[0].propeller_other"
          disabled
        ></fish-input>
      </fish-col>
    </fish-row>
